...
export const api = {
  ...
  importGallery: (id: string, galleryPath: string) => request<{ added_count: number; skipped_count: number; message: string }>(`/api/projects/${id}/gallery/import`, { method: 'POST', body: JSON.stringify({ gallery_path: galleryPath }) }),
